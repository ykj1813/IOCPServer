...
set PROJECT_FILE=".\DDServerMain.sln"
...
msbuild %PROJECT_FILE% /p:Configuration=%CONFIG% /p:Platform=%PLATFORM% /T:%ACTION%  /fileLogger /flp:logfile=%LOG_FILE_PATH%;verbosity=diagnostic
